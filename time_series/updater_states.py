...
with open("daily_data/4-12-20.json", 'r') as myfile:
    data = myfile.read()
...
with open("./daily_data/4-11-20.json", 'r') as myfile:
    data1 = myfile.read()
...
with open("./archived_time_series/states_up_to_4-11-20.json", 'r') as myfile:
    data2 = myfile.read()
...
with open("./time_series_daily_update/states_up_to_4-12-20.json", "w") as outfile:
    outfile.write(obj_JSON)

with open("./archived_time_series/states_up_to_4-12-20.json", "w") as outfile:
    outfile.write(obj_JSON)