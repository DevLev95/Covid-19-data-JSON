...
with open("time_series/daily_data/3-31-20.json", 'r') as myfile:
    data = myfile.read()
...
with open("time_series/daily_data/3-30-20.json", 'r') as myfile:
    data1 = myfile.read()
...
with open("update_states1.json", 'r') as myfile:
    data2 = myfile.read()
...
with open("time_series/time_series_daily_update/up_to_3-31-20.json", "w") as outfile:
